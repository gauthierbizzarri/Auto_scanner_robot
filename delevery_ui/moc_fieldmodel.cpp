...
QT_MOC_LITERAL(3, 20, 7), // "newPath"
QT_MOC_LITERAL(4, 28, 17), // "setRobotAvailable"
QT_MOC_LITERAL(5, 46, 5) // "robot"

    },
    "FieldModel\0changed\0\0newPath\0"
    "setRobotAvailable\0robot"
};
...
void FieldModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->newPath((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        case 2: _t->setRobotAvailable((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FieldModel::changed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FieldModel::*)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FieldModel::newPath)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FieldModel::changed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void FieldModel::newPath(QJsonObject _t1)
{
