...
QT_MOC_LITERAL(3, 23, 8), // "timedout"
QT_MOC_LITERAL(4, 32, 15), // "clientConnected"
QT_MOC_LITERAL(5, 48, 14) // "clientTimedout"

    },
    "MQTTManager\0connected\0\0timedout\0"
    "clientConnected\0clientTimedout"
};
...
void MQTTManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->clientTimedout(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MQTTManager::connected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MQTTManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MQTTManager::timedout)) {
                *result = 1;
                return;
            }
        }
